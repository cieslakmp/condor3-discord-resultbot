# condor3-discord-resultbot
A simple powershell script to take a results log file generated by DSHelper.exe (Condor 3 simulator), tidy it up a bit, and send it to a Discord Webhook.
